...
const PP = () => {
  return(
    <View>
      <Image source={{ uri: 'https://i.pinimg.com/originals/73/c7/8b/73c78bb39d6f803ba5896ab1f823a8f5.jpg' }} style ={styles.pp} />
    </View>
  ) 
};
const Profile = () => {
  ...
  return(
    <View>
      <Text style ={styles.profile}>{fname} {mname} {lname}</Text>
    </View>
  )
};
const Course = props =>{
